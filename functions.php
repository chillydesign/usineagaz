...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        'primary-navigation' => __('Primary Navigation', 'webfactor'), // Main Navigation
...
function create_post_type_partenaire()
{
    ...
    register_post_type('partenaire', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'singular_name' => __('Partenaires', 'webfactor'),
            'add_new' => __('Add New', 'webfactor'),
            'add_new_item' => __('Add New Partenaire', 'webfactor'),
            'edit' => __('Edit', 'webfactor'),
            'edit_item' => __('Edit Partenaire', 'webfactor'),
            'new_item' => __('New Partenaire', 'webfactor'),
            'view' => __('View Partenaire', 'webfactor'),
            'view_item' => __('View Partenaire', 'webfactor'),
            'search_items' => __('Search Partenaire', 'webfactor'),
            'not_found' => __('No Partenaires found', 'webfactor'),
            'not_found_in_trash' => __('No Partenaires found in Trash', 'webfactor')
        ),
        'public' => true,
